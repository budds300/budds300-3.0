...
export function Header() {
  ...
  return (
    <header className="sticky top-0 z-30 px-3 pt-3">
      <nav
        className={`mx-auto flex max-w-5xl items-center justify-between rounded-full border px-4 py-3 backdrop-blur-xl transition-all duration-300 sm:px-5 ${
          scrolled
            ? "border-accent/30 bg-background-elevated/92 shadow-[0_18px_60px_rgb(0_0_0/0.28)]"
